function []=GaborAnalysisOneCall(subjectIDs, phase, quit, preliminary, threshold, groupings, directory)
...
for i=1:length(subjectIDs)
   if quit(i)==1
       SaveQuitDataGabor(cellstr(subjectIDs{i}), phase, directory);
   end
   if i>1
...
Gabor_Analysis(cell2mat(subjectID1), groupings, preliminary, phase, directory);
