function [aic, aic_err, model_info, sampleses] = ModelComparison(base_params, signals, choices, prefix, model_names)
...
model_info = struct(...
    ...
    'fields', {{'prior_C', 'log_temperature', 'log_lapse', 'gamma', 'samples'}, ...
              ...
              {'prior_C', 'log_temperature', 'log_lapse', 'gamma', 'bound', 'log_noise'}, ...
              {'prior_C', 'log_temperature', 'log_lapse', 'gamma_1', 'gamma_2', 'bound', 'log_noise'}, ...
              {'prior_C', 'log_temperature', 'log_lapse', 'gamma_1', 'gamma_2', 'bound', 'log_noise'}, ...
